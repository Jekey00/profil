...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // VISOR – shaped as a front cap of a sphere. Eigenes Material (nicht blackGloss
    // wiederverwenden!) mit hoher, aber nicht voller Opacity - die Augen liegen
    // ohnehin geometrisch VOR dem Visor (z=0.9 vs. Visor-Vorderkante ~0.73) und
    // werden zusätzlich mit renderOrder darüber gezeichnet, brauchen also keine
    // starke Materialtransparenz zum "Durchscheinen".
    ...
    visor.renderOrder = 1; // nach Outline/Bubble zeichnen, damit er nicht "ausgewaschen" wirkt
    ...
    // Chat-Setup: läuft direkt hier, da wir bereits innerhalb des äußeren
    // DOMContentLoaded sind (ein zweiter Listener auf dasselbe Event würde
    // nie mehr feuern, da das Event nur einmal pro Seitenaufruf ausgelöst wird)
